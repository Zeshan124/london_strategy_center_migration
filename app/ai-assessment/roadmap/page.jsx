        ...
        <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-12 max-w-4xl">
          ...
          {showRoadmap && (
            <div className="flex flex-col sm:flex-row gap-4 mt-8">
              ...
              <Link href="/ai-assessment/results" className="flex-1 sm:flex-none px-8 py-3.5 border border-gray-200 text-gray-700 font-medium rounded-xl text-sm text-center hover:bg-gray-50 transition-colors">
                ← Back to Results
              </Link>
              <Link href="/ai-assessment" className="flex-1 sm:flex-none px-8 py-3.5 border border-gray-200 text-gray-700 font-medium rounded-xl text-sm text-center hover:bg-gray-50 transition-colors">
                Retake Assessment
              </Link>
            </div>
          )}
