    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white/30 text-xs mt-2">If this takes too long, <Link href="/ai-direction-scan" className="underline">restart the assessment</Link></p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0a0f1e]">
      ...
      <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-12 max-w-4xl space-y-8">
        ...
        <div className="bg-[#e63946] rounded-2xl p-6 sm:p-8 text-center">
          ...
          <Link
            href="/ai-direction-scan/roadmap"
        ...
        <div className="flex justify-center">
          <Link href="/ai-direction-scan" className="text-white/40 text-xs hover:text-white/60 transition-colors">← Retake Assessment</Link>
        </div>
      </div>
    </div>
  );
