...
export default function AdvisoryServiceHero({ service }) {
        ...
        <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-12 sm:py-16 lg:py-20">
          ...
          {service.showCta && (
            <div className="flex flex-wrap gap-3 mb-10">
              ...
              >
                {service.consultationCta || "Contact the Advisory Team"}
              </button>
            </div>
          )}
          ...
          >
            ...
            <div className="mb-6">
              <h2 className="text-2xl sm:text-3xl font-light text-gray-900 leading-tight mb-2">
                {service.consultationHeading || "Contact the Advisory Team"}
              </h2>
