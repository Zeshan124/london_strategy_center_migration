          ...
          <div className="flex flex-col gap-5">
            ...
            <form onSubmit={handleSubscribe} className="flex items-stretch">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-[#0E2253] text-white text-xs font-bold uppercase rounded-r-lg hover:bg-[#1a3570] transition-colors whitespace-nowrap disabled:opacity-60"
              >
            ...
            {subStatus === "success" && (
              <p className="text-xs text-green-700 font-medium">✓ You're subscribed! Thank you for joining us.</p>
            )}
            {subStatus === "error" && (
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                href="https://www.youtube.com/@LSCConnect"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center border-2 border-slate-900 rounded-full hover:bg-slate-900 hover:text-white transition-all"
                aria-label="YouTube"
              ...
              <a
                href="https://www.facebook.com/londonstrategycentreuk/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center border-2 border-slate-900 rounded-full hover:bg-slate-900 hover:text-white transition-all"
                aria-label="Facebook"
              ...
              <a
                href="https://www.instagram.com/londonstrategycentre/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center border-2 border-slate-900 rounded-full hover:bg-slate-900 hover:text-white transition-all"
              ...
              <a
                href="https://www.tiktok.com/@londonstrategycentreuk"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 flex items-center justify-center border-2 border-slate-900 rounded-full hover:bg-slate-900 hover:text-white transition-all"
                aria-label="TikTok"
