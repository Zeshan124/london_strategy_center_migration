...
import { Menu, Search, ChevronLeft, ChevronRight, Pause, Play } from 'lucide-react';
...
export default function HeroSection() {
  ...
  const articles = [
    {
      ...
      description: 'The DNA of work is being rewritten by AI. CEOs must go beyond deploying tools and help their organization reimagine the nature of work itself.',
    ...
    {
      id: 2,
      image: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=800&h=1000&fit=crop',
      category: 'Marketing and Sales',
      categoryLink: '/marketing-sales',
      title: 'The Agentic Marketing Race Is On. CMOs That Move First Will Win.',
      description: 'Agentic AI is ushering in a new era for marketing, one where autonomous systems learn, decide, and act alongside human teams.',
      date: 'November 25, 2025',
      type: 'Article',
    ...
    },
    {
      ...
      title: 'Reshaping a Business Portfolio Is Hard—What Separates the Best from the Rest?',
      description: 'Most efforts fail to outperform. But embracing six best practices significantly tilts the odds in your favor.',
    ...
    },
    {
      ...
      description: 'As climate change and the resulting extreme weather events continue to cause economic losses worldwide, nations are imposing various adaptation and resilience strategies.',
    ...
    },
    {
      ...
      title: 'Art and Algorithms: What CEOs Should Look For in an AI-First Chief Marketing Officer',
      description: 'AI is redefining marketing as a growth engine—and repositioning the CMO as a chief growth architect.',
    ...
    },
    {
      ...
      description: 'Agentic AI is both software and colleague—a form of artificial intelligence that acts. Organizations that swiftly adapt their management playbook to make full use of this transformative technology will gain the edge.',
      date: 'November 18, 2025',
      type: 'Article',
  ...
  const getSlideClass = (index) => {
    ...
    if (position === -1 || position === 1) return 'adjacent';
    if (position === -2 || position === 2) return 'far';
    return 'hidden';
  };
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white z-50 border-b border-gray-200">
        <div className="flex items-center justify-between px-6 lg:px-8 py-4">
          <div className="flex items-center gap-6">
            ...
            <div className="text-2xl font-bold tracking-tight">BCG</div>
          </div>
            ...
            {getOrderedSlides().map((article, displayIndex) => {
              ...
              return (
                  ...
                  className={`
                    ...
                    ${position === 0 ? 'w-[240px] sm:w-[280px] lg:w-[250px] h-[350px] opacity-100 z-30' : ''}
                    ${position === -1 || position === 1 ? 'w-[180px] sm:w-[210px] lg:w-[210px] h-[300px] opacity-80 z-20' : ''}
                    ${position === -2 || position === 2 ? 'w-[140px] sm:w-[170px] lg:w-[200px] h-[340px] opacity-50 z-10' : ''}
                  `}
                >
                  <div className="relative w-full h-full rounded-lg overflow-hidden shadow-xl group">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end text-white">
                      ...
                      <div className="px-5 mb-2 transition-all duration-700">
                        <span className="inline-block px-2.5 py-1 bg-white/20 backdrop-blur-sm rounded text-xs font-semibold tracking-wide uppercase">
                          {article.category}
                        </span>
                      </div>
                      ...
                      <div className="px-5 pb-5 translate-y-full group-hover:translate-y-0 transition-transform duration-700 ease-out">
                        ...
                        {(position === 0 || position === -1 || position === 1) && (
                          <>
                            <h3 className={`font-light mb-3 leading-snug ${
                              position === 0 ? 'text-xl lg:text-2xl line-clamp-3' : 'text-base lg:text-lg line-clamp-2'
                            }`}>
                              {article.title}
                            </h3>
