              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Content Card */}
                    <div
                      className="group relative w-64 bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-200/50 hover:border-slate-300 overflow-hidden"
                    ...
                    {/* Connecting Line */}
                    <div
                      className={`w-1 bg-gradient-to-b from-[#5B7AAE] to-[#5B7AAE] ${isTop ? "h-20" : "h-20"}`}
                    ></div>

                    {/* Icon Circle */}
                    <div className="relative flex-shrink-0">
                      {/* Outer Glow */}
                     <div className="absolute inset-0  rounded-full blur-xl opacity-40 scale-125 shadow-2xl"></div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative flex-shrink-0 z-10">
                      {/* Outer Glow */}
                      <div className="absolute inset-0  rounded-full blur-lg opacity-40 scale-125"></div>
