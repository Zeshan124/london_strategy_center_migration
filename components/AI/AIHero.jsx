...
export default function AIHero() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await submitLeadForm(formData.fullName, formData.email, 'artificial-intelligence');
    } catch {}
    setSubmitting(false);
    setShowForm(false);
    setShowSuccess(true);
      ...
      <div className="mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 py-8 sm:py-8 md:py-8 lg:pt-16">
        ...
        <div className="rounded-2xl overflow-hidden relative min-h-[340px] sm:min-h-[450px]">
          ...
          <div className="relative z-10 flex flex-col justify-center px-8 sm:px-10 md:px-12 py-12 h-full min-h-[340px] sm:min-h-[420px]">
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-light text-white leading-tight mb-3">
  AI-Augmented<br />Organisational<br />Transformation
</h1>
