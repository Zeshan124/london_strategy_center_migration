export const CYBER_SERVICES = {
  "certification-and-compliance": {
    ...
    image: "/images/InnerPages/cyber-security/Certification_and_Compliance.jpg",
    ...
    practiceAreas: {
      ...
      features: [
        { id: 1, icon: "/images/InnerPages/cyber-security/cloud_sync.svg", title: "Cyber Essentials", description: "Certification support covering the five core technical controls. LSC guides organisations through self-assessment preparation, evidence gathering, and remediation of identified gaps." },
        { id: 2, icon: "/images/InnerPages/cyber-security/bookmark_added.svg", title: "Cyber EssentialsPlus (CE+)", description: "Hands-on assessment preparation including technical verification of controls, vulnerability testing readiness, and remediation planning for CE+ requirements." },
        { id: 3, icon: "/images/InnerPages/cyber-security/database_search.svg", title: "NCNICC-1:2025", description: "Cybersecurity gap analysis and internal auditing services to private sector organisations strengthen cyber resilience, mitigate risks, achieve regulatory compliance, and support Saudi Vision 2030 digital transformation objectives." },
        { id: 4, icon: "/images/InnerPages/cyber-security/display_external_input.svg", title: "IASME Cyber Assurance", description: "Certification support for the IASME governance framework, which extends beyond Cyber Essentials to include GDPR assurance and broader governance requirements." },
        { id: 5, icon: "/images/InnerPages/cyber-security/insert_chart.svg", title: "ISO 27001", description: "Gap analysis against ISO 27001 requirements, internal audit support, implementation of information security management systems (ISMS), and preparation for external certification audits." },
        { id: 6, icon: "/images/InnerPages/cyber-security/lock.svg", title: "NIST Cyber Security Framework (CSF)", description: "Assessment and implementation support across all NIST CSF functions: Identify, Protect, Detect, Respond, and Recover. Includes guidance on associated NIST 800 series publications relevant to the organisation's environment." },
         { id: 7, icon: "/images/InnerPages/cyber-security/privacy_tip.svg", title: "Defence Cyber Certification (DCC)", description: "Preparation support for organisations in the defence supply chain, aligning security practices with MOD requirements and demonstrating compliance through structured evidence." },
        { id: 8, icon: "/images/InnerPages/cyber-security/Group_433.svg", title: "PCI DSS", description: "Readiness assessments for payment card industry data security standards, identifying gaps and providing remediation guidance to meet PCI DSS requirements." },
      ],
    },
    cta: {
      ...
      image: "/images/InnerPages/cyber-security/1.jpg",
    },
    partner: {
  ...
  "technical-security-services": {
    ...
    practiceAreas: {
      ...
      features: [
        { id: 1, icon: "/images/InnerPages/cyber-security/penetration-testing.svg", title: "Vulnerability Scanning", description: "Identifies security weaknesses across networks, systems, and applications through automated assessment. Scanning provides broad coverage, detecting known vulnerabilities, misconfigurations, and missing patches across the environment. Results are prioritised by severity and exploitability, enabling focused remediation." },
        { id: 2, icon: "/images/InnerPages/cyber-security/penetration-testing.svg", title: "Penetration Testing", description: "Simulates real-world cyber attacks to identify exploitable weaknesses in systems and networks. Where vulnerability scanning identifies what is theoretically vulnerable, penetration testing demonstrates what an attacker could actually achieve. Testing is conducted against defined scope and rules of engagement, with findings reported in both technical detail and business-impact terms." },
        { id: 3, icon: "/images/InnerPages/cyber-security/penetration-security.svg", title: "Technical Security Assessments", description: "Evaluate the security of IT infrastructure, applications, and cloud environments through structured review. Assessments examine configuration, architecture, access controls, and security monitoring - providing a detailed picture of how well the technical environment supports the organisation's security requirements." },
      ],
     ...
     features: [
  {
    ...
    description: "Ensures security is integrated into systems during development rather than added retrospectively. This is not a documentation exercise. It requires security requirements to be defined at the architecture stage, threat models to inform design decisions, and security evidence to be generated as the system is built. LSC supports organisations in making Secure by Design a practical reality rather than a compliance aspiration."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "Evaluate cyber risks associated with suppliers and partners within the defence supply chain. The process identifies vulnerabilities that could affect programme security, including third-party access, data handling practices, and configuration management, and provides prioritised recommendations to reduce risk. These assessments are designed to meet the expectations of prime contractors and MOD security assurance processes.",
  },
  {
    id: 4,
    icon: "/images/InnerPages/cyber-security/defence_programme.svg",
    title: "Defence Programme Cyber Governance",
    description: " Ensures security oversight is integrated into defence programme structures. This includes defining accountability for cyber risk within programme governance, establishing assurance processes that align with programme milestones, and ensuring cyber risk management is embedded within broader programme governance rather than managed as a separate work stream.",
  }
],
 ...
 heading_bottom: "Assessments designed for operational reality",
    ...
    cta: {
      heading: "Standard IT security models do not translate to operational environments",
      paragraphs: [
  ...
  "cyber-strategy-and-governance-advisory": {
    ...
    image: "/images/InnerPages/cyber-security/Governance_advisory.jpg",
...
"London Strategy Centre provides advisory services that help leadership teams build strong cyber governance, develop security strategies, improve maturity, and manage cyber risk at organisational and board level.",
    ...
    practiceAreas: {
      isStatic: true,
      heading: "Six advisory services for strategic cyber governance",
      subheading: "LSC's cyber strategy and governance advisory services are designed for leadership teams that recognise cyber security as an organisational responsibility, not solely a technical function.",
      features: [
  {
    id: 1,
    icon: "/images/InnerPages/cyber-security/security_governance.svg",
    title: "Security Governance Framework Design",
    description:
  ...
  },
  {
    ...
    title: "Virtual CISO (CISO-as-a-Service)",
    description:
  ...
  },
  {
    ...
    title: "Board-Level Cyber Risk Advisory",
    description:
  ...
  {
    id: 5,
    icon: "/images/InnerPages/cyber-security/Information_Assurance.svg",
    title: "Information Assurance Strategy",
    description:
  ...
  {
    id: 6,
    icon: "/images/InnerPages/cyber-security/security_policy.svg",
    title: "Security Policy Development and Review",
    description:
...
"This is not a technical capability. It is a governance and leadership capability - and it is where LSC's advisory services are focused.",
      ...
      image: "/images/InnerPages/cyber-security/2.jpg",
    },
    faqs: [
    ...
    partner: {
      image: "/images/InnerPages/cyber-security/cta-section-12.jpg",
      heading: "Who this is for",
      paragraphs: [
  ...
  "specialist-programme-support": {
    ...
    image: "/images/InnerPages/cyber-security/3.jpg",
...
"The result is rework, delay, and accepted residual risk that a structured security workstream would have prevented. The earlier security expertise is embedded in a programme, the lower the cost and the stronger the outcome.",
      ...
      image: "/images/InnerPages/cyber-security/cta-section-13.jpg",
    },
    faqs: [
    ...
    partner: {
      image: "/images/InnerPages/cyber-security/cta-section-15.jpg",
      heading: "Who this is for",
      paragraphs: [
