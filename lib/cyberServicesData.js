export const CYBER_SERVICES = {
  "certification-and-compliance": {
    ...
    practiceAreas: {
      ...
      features: [
        ...
        { id: 3, icon: "/images/InnerPages/cyber-security/database_search.svg", title: "NCC ICS-1:2025", description: "Cybersecurity gap analysis and internal auditing services to private sector organisations strengthen cyber resilience, mitigate risks, achieve regulatory compliance, and support Saudi Vision 2030 digital transformation objectives.", slug: "certification-and-compliance" },
  ...
  "technical-security-services": {
    ...
    practiceAreas: {
      ...
      features: [
        { id: 1, icon: "/images/InnerPages/cyber-security/penetration-testing.svg", title: "Vulnerability Scanning", description: "Identifies security weaknesses across networks, systems, and applications through automated assessment. Scanning provides broad coverage, detecting known vulnerabilities, misconfigurations, and missing patches across the environment. Results are prioritised by severity and exploitability, enabling focused remediation.", slug: "technical-security-services" },
        { id: 2, icon: "/images/InnerPages/cyber-security/penetration-testing.svg", title: "Penetration Testing", description: "Simulates real-world cyber attacks to identify exploitable weaknesses in systems and networks. Where vulnerability scanning identifies what is theoretically vulnerable, penetration testing demonstrates what an attacker could actually achieve. Testing is conducted against defined scope and rules of engagement, with findings reported in both technical detail and business-impact terms.", slug: "technical-security-services" },
