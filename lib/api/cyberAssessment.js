// Same-origin base URL — proxies to lsc.impressoft.com server-side to avoid CORS.
// Matches the working pattern e.g. https://londonstrategycentre.com/api/blogs
const API_BASE = 'https://londonstrategycentre.com/api';
